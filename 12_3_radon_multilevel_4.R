#' ---
#' title: Multilevel model of radon levels IV
#' author: Brett Melbourne
#' date: 1 Nov 2018 (updated 7 Nov 2022)
...
#' Read in data and manipulate as required for analysis (see Parts II & III)
...
#' necessarily interested in its distribution (thus, I do not choose a histogram
#' here).
...
#' uranium as a predictor (see Part III). The difference is that the intercepts
...
#' their plot is not strictly for the intercepts as labelled on their y-axis).
#' 
...
#' (larger standard errors) in the estimate of radon level in each county (this
#' is because the uncertainty in the variance parameters is propagated to the
#' posterior distribution for the county means, whereas the variance parameters
#' in the frequentist analysis, once estimated, are assumed fixed).