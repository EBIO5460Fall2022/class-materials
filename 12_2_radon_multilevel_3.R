...
#' date: 28 Oct 2018 (updated 3 Nov 2022)
...
#' This is part III. In part I we did EDA, in part II we considered a variance
#' components model for homes within counties, introducing the concept of
#' partial pooling and shrinkage (G&H 12.2). Here, we'll consider a house-level
#' (G&H 12.3-4) predictor of radon. In part IV, we'll consider a county-level
#' predictor.
#' 
...
#' different way of coding the variable (either way, the parameter estimate will
#' be the same). We will follow their analysis.
#' 
...
#' The feature to notice here is how the uncertainty intervals are large for
#' counties with small sample sizes and decrease with sample size.
#' 
